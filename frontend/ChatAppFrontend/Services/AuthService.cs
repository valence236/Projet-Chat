    ...
    public class AuthService
    {
        ...
        public async Task<bool> RegisterAsync(string username, string email, string password)
        {
            ...
            try
            {
                ...
                {
                    var json = await response.Content.ReadAsStringAsync();
                    var registerResponse = JsonSerializer.Deserialize<LoginResponse>(json, new JsonSerializerOptions
                    {
                        PropertyNameCaseInsensitive = true
                    });
                    ...
                    {
                        SessionManager.Token = registerResponse.Token;
                        SessionManager.Username = registerResponse.Username;
                        return true;
                    }
                }
